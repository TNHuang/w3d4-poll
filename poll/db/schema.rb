...
ActiveRecord::Schema.define(version: 20140925155023) do
  ...
  create_table "my_polls", force: true do |t|
    t.string   "title"
    t.integer  "author_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "my_polls", ["author_id"], name: "index_my_polls_on_author_id", using: :btree
